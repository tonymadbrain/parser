...
redis = Redis.new
items1 = redis.hgetall("items1")
puts items1
items2 = redis.hgetall("items2")
puts items2
items3 = redis.hgetall("items3")
puts items3
